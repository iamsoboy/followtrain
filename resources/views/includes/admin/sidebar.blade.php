...
<sidebar id="sidebar" class="app-sidebar">
    ...
    <div class="app-sidebar-content" data-scrollbar="true" data-height="100%">
        ...
        <div class="menu">
            ...
            <div class="menu-header">Train(s)</div>
            <div class="menu-item">
                <a href="{{route('locate.index')}}" class="menu-link">
            ...
            <div class="menu-item has-sub">
                <a href="#" class="menu-link">
                    <span class="menu-icon"><i class="fa fa-train"></i></span>
                    <span class="menu-text"> Manage Train</span>
                    <span class="menu-caret"><b class="caret"></b></span>
                </a>
                <div class="menu-submenu">
                    <div class="menu-item">
                        <a href="{{route('train.index')}}" class="menu-link">
                            <span class="menu-text">Add Train</span>
                        </a>
                    </div>
                </div>
            </div>
            <div class="menu-item">
                <a href="{{route('trips.index')}}" class="menu-link">
                    ...
                    <span class="menu-text">Train Trips</span>
                </a>
            </div>
            <div class="menu-item">
                <a href="{{route('ticket.index')}}" class="menu-link">
                    <span class="menu-icon"><i class="fa fa-ticket-alt"></i></span>
                    <span class="menu-text">Train Tickets</span>
                </a>
            </div>
